...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/csharp-001-exercicio-eshop.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd csharp-001-exercicio-eshop`
  ...
  - Agora, crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-csharp-001-exercicio-eshop`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-csharp-001-exercicio-eshop`

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/csharp-001-exercicio-eshop`/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/csharp-001-exercicio-eshop`/pulls) e confira que o seu _Pull Request_ está criado
